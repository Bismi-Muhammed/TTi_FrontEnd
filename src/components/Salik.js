...
//         url = "http://localhost:3000/data/salik/today";
//       } else if (selectedDate === "lastWeek") {
//         url = "http://localhost:3000/data/salik/last-week";
//       } else if (selectedDate === "last2Weeks") {
//         url = "http://localhost:3000/data/salik/last-2-weeks";
//       } else if (selectedDate === "last3Weeks") {
//         url = "http://localhost:3000/data/salik/last-3-weeks";
//       } else if (selectedDate === "last4Weeks") {
//         url = "http://localhost:3000/data/salik/last-4-weeks";
//       }
...
const Salik = () => {
  ...
  // Filter AM and PM peak data
  const amData = filteredData.filter((row) => row.am_peak_avg_travel_time > 0);
  const pmData = filteredData.filter((row) => row.pm_peak_avg_travel_time > 0);
  ...
  const avgAmTTI = calculateAvgTTI(amData, "am");
  const avgPmTTI = calculateAvgTTI(pmData, "pm");
